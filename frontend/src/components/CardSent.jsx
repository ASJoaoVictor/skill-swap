...
const CardSent = ({match, cancelMatch}) => {
    return <div className="bg-white rounded-md">
        ...
        <div className="flex justify-between mt-2 pb-2 mx-36 gap-2">
            <div onClick={cancelMatch} className="flex justify-center w-full p-2 rounded-md border border-yellow-300 text-yellow-300 hover:bg-yellow-300 hover:text-white">
