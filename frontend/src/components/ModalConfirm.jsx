...
const ModalConfirm = ({action, title, message, onCancel}) => {
        ...
        <div className="flex justify-center items-center bg-black/20 h-screen w-screen">
            <div className="flex flex-col gap-4 bg-white p-8 rounded-md">
                ...
                <div className="flex justify-between gap-8">
                    ...
                    <button onClick={action} className="bg-red-500 text-white p-2 rounded-md w-full hover:opacity-70">Deletar</button>
                </div>
            </div>
        </div>
    </div>
